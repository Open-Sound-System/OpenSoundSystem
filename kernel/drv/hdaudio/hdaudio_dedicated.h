 ...
 */
#define COPYING104 Copyright (C) Hannu Savolainen and Dev Mazumdar 2004-2006. All rights reserved.
...
#define HDA_INMUTE(wid, ix, group, name, muted) ctl=hda_codec_add_inmute(dev, mixer, cad, wid, ix, group, name, muted)
